	...
	if(href_list["autoresponse"]) // new verb on the Ahelp.  Will tell the person their message was received, and they probably won't get a response
		...
		switch(choice)
			...
			if("L: ѕервичное –уководство  сеноморфа")
				msgplayer = "\blue <b>«јћ≈“ ј: <font color=red>[usr.key]</font> воспользовался авто-ответом <font color='#009900'>'[choice]'</font>. ќтвет на ваш вопрос может быть найден в ѕервичном –уководстве  сеноморфа. <font color='#009900'><a href='http://wiki.ss13marines.ru/index.php?title=Xeno_Quickstart_Guide'>—сылка на руководство</a></font>.</b>"
			if("L: ѕервичное –уководство ћорпеха")
				msgplayer = "\blue <b>«јћ≈“ ј: <font color=red>[usr.key]</font> воспользовался авто-ответом <font color='#009900'>'[choice]'</font>. ќтвет на ваш вопрос может быть найден в ѕервичном –уководстве ћорпеха. <font color='#009900'><a href='wiki.ss13marines.ru/index.php?title=Marine_Quickstart_Guide'>—сылка на руководство</a></font>.</b>"
			if("L: Ёкипировка ћорпехов")
				msgplayer = "\blue <b>«јћ≈“ ј: <font color=red>[usr.key]</font> воспользовался авто-ответом <font color='#009900'>'[choice]'</font>. ќтвет на ваш вопрос может быть найден на странице вики \"Ёкипировка ћорпехов\". <font color='#009900'><a href='http://wiki.ss13marines.ru/index.php?title=%D0%AD%D0%BA%D0%B8%D0%BF%D0%B8%D1%80%D0%BE%D0%B2%D0%BA%D0%B0_%D0%BC%D0%BE%D1%80%D0%BF%D0%B5%D1%85%D0%BE%D0%B2'>—сылка на страницу</a></font>.</b>"
			if("L: “екущая  арта")
