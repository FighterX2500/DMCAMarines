	...
	switch(act)
		...
		if ("gasp")
			if (!muzzled)
				...
				var/gasp_sound_m = pick('sound/effects/emotes/m_heavyb1.ogg','sound/effects/emotes/m_heavyb2.ogg','sound/effects/emotes/m_heavyb3.ogg',
				...
				var/gasp_sound_f = pick('sound/effects/emotes/f_heavyb1.ogg','sound/effects/emotes/f_heavyb2.ogg','sound/effects/emotes/f_heavyb3.ogg',
				...
				if(src.gender == "male")
					playsound(src.loc, gasp_sound_m, 10, 0)
				else if(src.gender == "female")
					playsound(src.loc, gasp_sound_f, 10, 0)
				m_type = 2
			else
		...
		if ("pain")
			...
			m_type = 2
			if(!recent_audio_emote || !player_caused)//cooldown only affect emote generated by the player
				var/pain_sound_m = pick('sound/effects/emotes/m_pain1.ogg','sound/effects/emotes/m_pain2.ogg','sound/effects/emotes/m_pain3.ogg',
				...
				var/pain_sound_f = pick('sound/effects/emotes/f_pain1.ogg','sound/effects/emotes/f_pain2.ogg','sound/effects/emotes/f_pain3.ogg',
				...
				if(has_species(src,"Human") && src.client)
					if(gender == "male")
						playsound(loc, pain_sound_m, 25)
					else
						playsound(loc, pain_sound_f, 25)
				if(player_caused)
					start_audio_emote_cooldown()
			else
				to_chat(src, "You just did an audible emote. Wait a while.")
