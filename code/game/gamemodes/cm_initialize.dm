...
/datum/game_mode/proc/initialize_post_marine_gear_list()
	...
	for(var/X in cargo_ammo_vendors)
		...
		CA.products = list(
						...
						/obj/item/ammobox/s22 = round(scale * 1),
						/obj/item/ammobox/s22buckshot = round(scale * 1),
						/obj/item/ammobox/s22incendiary = round(scale * 1),
	...
	for(var/X in cargo_guns_vendors)
		...
		CG.products = list(
						...
						/obj/item/weapon/shield/montage/marine = round(scale * 4),
