...
/datum/game_mode/proc/initialize_post_marine_gear_list()
	...
	for(var/X in cargo_ammo_vendors)
		...
		CA.products = list(
						...
						/obj/item/ammo_magazine/rifle/saiga = round(scale * 20),
						/obj/item/ammo_magazine/rifle/saiga/buckshot = round(scale * 20),
						/obj/item/ammo_magazine/rifle/saiga/incendiary = round(scale * 10),
	...
	for(var/X in cargo_guns_vendors)
		...
		CG.products = list(
						...
						/obj/item/weapon/gun/rifle/saiga = round(scale * 15),
	...
	for(var/obj/machinery/vending/marine/M in marine_vendors)
		...
		M.products = list(
						...
						/obj/item/ammo_magazine/rifle/saiga = round(scale * 20),
						/obj/item/ammo_magazine/rifle/saiga/buckshot = round(scale * 10),
