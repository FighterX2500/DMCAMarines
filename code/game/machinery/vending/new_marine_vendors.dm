...
//							list("Smoke grenade", 2, /obj/item/explosive/grenade/smokebomb, null, "black"),
							...
							list("M41AE2 ammo box (10x24mm)", 8, /obj/item/ammo_magazine/rifle/lmg, null, "orange"),
							list("Tactical Binoculars", 10, /obj/item/device/binoculars/tactical, null, "orange"),
